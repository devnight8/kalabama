...
<section class="container max-w-[1480px] mx-auto border border-red-100 rounded-2xl p-4 flex flex-col">
...
<!-- BAKALAMA Flagship  -->
<section class="container max-w-[1480px] mx-auto border border-gray-400 rounded-2xl p-4 flex flex-col">
    <div class="flex items-center justify-between rounded-md p-4 ">
        <h4 class="text-black font-extrabold">پرچمداران هوشمند </h4>
        <button class="flex items-center justify-between gap-2 text-gray-800 font-extrabold ">
            نمایش همه
            <span class="rotate-90">
                <svg width="14" height="8" viewBox="0 0 14 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M13 1L7.70711 6.29289C7.31658 6.68342 6.68342 6.68342 6.29289 6.29289L1 1" stroke="#ddd" class="stroke-gray-800" stroke-width="2" stroke-linecap="round" />
                </svg>
            </span>
        </button>
    </div>
